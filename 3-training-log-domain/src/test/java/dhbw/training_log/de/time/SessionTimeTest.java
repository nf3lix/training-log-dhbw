...
import static dhbw.training_log.de.time.SessionTimeMatcher.hasTime;
...
public class SessionTimeTest {
    ...
    public void sessionTimeValueObjectBehavior() {
        ...
        performValueObjectTest(sessionTimes);
    }
    ...
    public void minutesValueObjectBehavior() {
        ...
        performValueObjectTest(minutes);
    }
    ...
    public void secondsValueObjectBehavior() {
        ...
        performValueObjectTest(seconds);
    }
