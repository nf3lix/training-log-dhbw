...
public class TrainingSessionResourceTest {
    ...
    public void fromCsvLine() {
        ...
        final TrainingSessionResource resource = TrainingSessionResource.fromCsvLine(line);
    ...
    public void toCsvLine() {
        ...
        assertEquals(line[4], TrainingSessionType.INTERVALS.name());
    }
