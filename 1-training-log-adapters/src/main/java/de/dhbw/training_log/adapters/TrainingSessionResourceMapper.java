...
public class TrainingSessionResourceMapper implements Function<TrainingSessionResource, TrainingSession> {

    @Override
    public TrainingSession apply(TrainingSessionResource resource) {
