...
public class CreateSession implements UseCaseInitializer {
    ...
    public void init(SessionRepository repository) {
        new CreateSessionServiceImpl(repository).run();
    }

    private static class CreateSessionServiceImpl extends CreateSessionService {

        public CreateSessionServiceImpl(SessionRepository repository) {
            super(repository);
        }
